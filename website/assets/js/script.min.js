  ...
  (function (e) {
    e.fn.extend({
      smoothproducts: function () {
        function t() {
          e(".sp-selected").removeClass("sp-selected"),
            e(".sp-lightbox").fadeOut(function () {
              e(this).remove()
            })
        }
        function a(e) {
          return e.match(/url\([\"\']{0,1}(.+)[\"\']{0,1}\)+/i)[1]
        }
        e(".sp-loading").hide(),
          e(".sp-wrap").each(function () {
            if ((e(this).addClass("sp-touch"), e("a", this).length > 1)) {
              var t,
                a,
                i = !!e("a.sp-default", this)[0]
              e(this).append(
                '<div class="sp-large"></div><div class="sp-thumbs sp-tb-active"></div>'
              ),
                e("a", this).each(function (s) {
                  var n = e("img", this).attr("src"),
                    r = e(this).attr("href"),
                    c = ""
                  ;((0 === s && !i) || e(this).hasClass("sp-default")) &&
                    ((c = ' class="sp-current"'),
                    (t = r),
                    (a = e("img", this)[0].src)),
                    e(this)
                ...
                e(".sp-wrap").css("display", "inline-block")
          ...
          e(document.body).on("click", ".sp-thumbs", function (e) {
            e.preventDefault()
          }),
          e(document.body).on("mouseover", function (t) {
            e(".sp-wrap").removeClass("sp-touch").addClass("sp-non-touch"),
              t.preventDefault()
          }),
          e(document.body).on("touchstart", function () {
            e(".sp-wrap").removeClass("sp-non-touch").addClass("sp-touch")
          }),
          e(document.body).on("click", ".sp-tb-active a", function (t) {
            t.preventDefault(),
              e(this).parent().find(".sp-current").removeClass(),
              e(this).addClass("sp-current"),
              e(this)
                .parents(".sp-wrap")
                .find(".sp-thumbs")
                .removeClass("sp-tb-active"),
              e(this).parents(".sp-wrap").find(".sp-zoom").remove()
            var i = e(this).parents(".sp-wrap").find(".sp-large").height(),
              s = e(this).parents(".sp-wrap").find(".sp-large").width()
            e(this)
              .parents(".sp-wrap")
              .find(".sp-large")
              .css({ overflow: "hidden", height: i + "px", width: s + "px" }),
              e(this)
                .addClass("sp-current")
                .parents(".sp-wrap")
                .find(".sp-large a")
                .remove()
            var n = e(this).parent().find(".sp-current").attr("href"),
              r = a(e(this).parent().find(".sp-current").css("backgroundImage"))
            e(this)
              .parents(".sp-wrap")
              .find(".sp-large")
              .html(
                ...
                .fadeIn(250, function () {
                  ...
                  e(this)
                    ...
                    .animate({ height: t }, "fast", function () {
                      e(".sp-large").css({ height: "auto", width: "auto" })
                    }),
                    e(this)
                      .parents(".sp-wrap")
                      .find(".sp-thumbs")
          ...
          e(document.body).on(
            ...
            function (t) {
              ...
              e(this).append(
                '<div class="sp-zoom"><img src="' + a + '"/></div>'
              ),
                e(this).find(".sp-zoom").fadeIn(250),
                t.preventDefault()
            }
          ),
          e(document.body).on(
          ...
          e(document.body).on("click", ".sp-non-touch .sp-zoom", function (t) {
            var a = e(this).html(),
              ...
              s =
                e(this)
                  ...
                  .index() + 1
            e(this).parents(".sp-wrap").addClass("sp-selected"),
              e("body").append(
              ...
              i > 1 &&
                (e(".sp-lightbox").append(
                  "<a href='#' id='sp-prev'></a><a href='#' id='sp-next'></a>"
                ),
                1 == s
                  ? e("#sp-prev").css("opacity", ".1")
                  : s == i && e("#sp-next").css("opacity", ".1")),
              e(".sp-lightbox").fadeIn(),
              t.preventDefault()
          }),
          ...
          e(document.body).on("click", "#sp-next", function (t) {
            ...
            if (i >= s);
              ...
              var n = i + 1,
                r = e(".sp-selected .sp-thumbs")
                  .find("a:eq(" + i + ")")
                  .attr("href"),
                c = a(
                  e(".sp-selected .sp-thumbs")
                    .find("a:eq(" + i + ")")
                    .css("backgroundImage")
                )
              i == s - 1 && e("#sp-next").css("opacity", ".1"),
                e("#sp-prev").css("opacity", "1"),
                e(".sp-selected .sp-current").removeClass(),
                e(".sp-selected .sp-thumbs a:eq(" + i + ")").addClass(
                  "sp-current"
                ),
                e(".sp-selected .sp-large")
                  .empty()
                  .append("<a href=" + r + '><img src="' + c + '"/></a>'),
                e(".sp-lightbox img").fadeOut(250, function () {
                  e(this).remove(),
                    e(".sp-lightbox")
                      .data("currenteq", n)
                      .append('<img src="' + r + '"/>'),
                    e(".sp-lightbox img").hide().fadeIn(250)
                })
            }
            t.preventDefault()
          }),
          e(document.body).on("click", "#sp-prev", function (t) {
            ...
            if (
              (t.stopPropagation(),
              0 >= (i = (i = e(".sp-lightbox").data("currenteq")) - 1))
            );
            else {
              1 == i && e("#sp-prev").css("opacity", ".1")
              var s = i - 1,
                n = e(".sp-selected .sp-thumbs")
                  .find("a:eq(" + s + ")")
                  .attr("href"),
                r = a(
                  e(".sp-selected .sp-thumbs")
              ...
              e("#sp-next").css("opacity", "1"),
                e(".sp-selected .sp-current").removeClass(),
                e(".sp-selected .sp-thumbs a:eq(" + s + ")").addClass(
                  "sp-current"
                ),
                e(".sp-selected .sp-large")
                  .empty()
                  .append("<a href=" + n + '><img src="' + r + '"/></a>'),
                e(".sp-lightbox img").fadeOut(250, function () {
                  e(this).remove(),
                    e(".sp-lightbox")
                      .data("currenteq", i)
          ...
          e(document.body).on("click", ".sp-lightbox", function () {
            t()
          }),
          e(document).keydown(function (e) {
            return 27 == e.keyCode ? (t(), !1) : void 0
          }),
          e(".sp-large").mousemove(function (t) {
            var a = e(this).width(),
              i = e(this).height(),
              s = e(this).find(".sp-zoom").width(),
              n = e(this).find(".sp-zoom").height(),
              r = e(this).parent().offset(),
              c = t.pageX - r.left,
              o = t.pageY - r.top,
              l = Math.floor((c * (a - s)) / a),
              p = Math.floor((o * (i - n)) / i)
            e(this).find(".sp-zoom").css({ left: l, top: p })
          })
      },
    })
  })(jQuery),
...
var pJS = function (e, t) {
  ...
  t && Object.deepExtend(i, t),
            ...
            if (i.tmp.bubble_duration_end)
              null != s &&
                ((o =
                  ...
                  (t -
                    (n -
                      (p * (n - t)) / i.interactivity.modes.bubble.duration))),
    ...
    (i.fn.vendors.drawShape = function (e, t, a, i, s, n) {
      ...
      for (var p = 0; p < r; p++) e.lineTo(i, 0), e.translate(i, 0), e.rotate(l)
      e.fill(), e.restore()
    }),
